        ...
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3">
          ...
          {isOwner && (
            <Link
              ...
              className="inline-flex shrink-0 items-center gap-1.5 rounded-lg border border-slate-200/80 bg-white/70 px-2.5 py-1 text-xs font-medium text-slate-700 shadow-sm hover:border-emerald-300 hover:text-emerald-800"
            >
